...
import { FilterField, Platform } from "@/enums";
...
export const DataTableFilters = ({
  ...
  return (
    <div className="flex gap-2 flex-wrap">
      ...
      >
        <TabsList>
          <TabsTrigger value={Platform.CROSSPLAY} title="Crossplay">
            <Icons.crossplay className="h-5 w-5 inline" />
          </TabsTrigger>
          <TabsTrigger value={Platform.STEAM} title="Steam">
            <Icons.steam className="h-5 w-5 inline" />
          </TabsTrigger>
          <TabsTrigger value={Platform.XBOX} title="Xbox">
            <Icons.xbox className="h-5 w-5 inline" />
          </TabsTrigger>
          <TabsTrigger value={Platform.PLAYSTATION} title="PlayStation">
