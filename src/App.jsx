...
const App = () => {
  ...
  return (
    <div className="container mb-12">
      ...
      <Tabs defaultActiveKey="1" items={[{ key: "1", label: "Closed Beta 1", children: <Leaderboard betaVersion={"1"} /> }, { key: "2", label: <>Closed Beta 2 <Badge status="success" /></>, children: <Leaderboard betaVersion={"2"} /> }]} />
    </div>
  );
};
