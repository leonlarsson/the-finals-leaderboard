...
const App = () => {
  ...
  return (
    <div className="container mb-12">
      ...
      <h5 className="text-xl">Top {users.length.toLocaleString("en-US")} players from the current playtest. You can find the official leaderboard <a href="https://www.reachthefinals.com/leaderboard-beta" target="_blank" className="link">here</a>. Created by <a href="https://twitter.com/mozzyfx" target="_blank" className="link">me</a>. Source <a href="https://github.com/leonlarsson/the-finals-leaderboard" target="_blank" className="link">here</a>.</h5>
      <hr />
